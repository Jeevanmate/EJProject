...
{
    /// <inheritdoc />
    public partial class testliked : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Image = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    LikedStatus = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "3781efa7-66dc-47f0-860f-e506d04102e4", 0, "5f5941c8-13f5-4fd4-a320-bce75cdf1f95", "admin@localhost.com", false, "Admin", "User", false, null, "ADMIN@LOCALHOST.COM", "ADMIN@LOCALHOST.COM", null, null, false, "dc5f8fd6-e28a-4af4-9b05-d8a35762af90", false, "admin@localhost.com" });
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductID", "Category", "Condition", "Description", "Image", "LikedStatus", "Price", "ProductName", "SellerID" },
                values: new object[,]
                {
                    { 1, "Electronics", "Good", "Brand new ipad", "", true, 69.7f, "Ipad Air", 1 },
                    { 2, "Clothes", "Excellent", "Brand new shirt", "", true, 220f, "Ralph Lauren Shirt", 2 }
                });
